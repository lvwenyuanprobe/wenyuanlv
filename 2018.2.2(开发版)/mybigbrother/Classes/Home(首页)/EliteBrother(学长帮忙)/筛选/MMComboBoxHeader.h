...
static  NSString *titleSelectedColor = @"fb6030";
static const CGFloat  ButtonFontSize = 14.0f;
//MMPopupView
static const CGFloat PopupViewRowHeight = 55.0f;
...
static const CGFloat ItemWidth  = 90.0f;
static const CGFloat ItemHorizontalMargin = 10.0f;
static const CGFloat ItemHorizontalDistance = 6.0f;
//MMDropDownBox
