...
#define kItemBgColor RGBCOLOR(245, 245, 245)        //item背景颜色
static const CGFloat kIconW = 20;       //图标宽(默认宽高相等)
static const CGFloat kFontSize = 18.0f; //字体大小

static const CGFloat kItemNameLeftSpace = 18;//itemName左边距
static const CGFloat kIconLeftSpace = 20;    //icon左边距离
...
- (NSDictionary *)config{
    if (!_config) {
        ...
        _fontColor = _fontColor?[UIColor blackColor]:[UIColor blackColor];
        _config = @{
                    @"iconW":@(_iconW),
                    @"fontSize":@(_fontSize),
