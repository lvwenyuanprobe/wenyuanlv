...
- (void)addRefreshHeaderWithClosure:(PSRefreshClosure)closure {
    if (!self.header && !self.gifHeader) {
        ...
        [self.header setTitle:@"松开立即刷新" forState:PSRefreshStateReleaseCanRefresh];
...
- (void)addRefreshFooterWithClosure:(PSRefreshClosure)closure {
    if (!self.footer && !self.gifFooter) {
        ...
        [self.footer setTitle:@"左拉加载更多" forState:PSRefreshStatePullCanRefresh];
        [self.footer setTitle:@"松开加载更多" forState:PSRefreshStateReleaseCanRefresh];
