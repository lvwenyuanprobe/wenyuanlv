...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"sy_fb"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"sy_fb"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    //调整发布按钮的中线点Y值
    self.plusBtn.centerY = self.height * 0.5 - 2*LBMagin + 2;
