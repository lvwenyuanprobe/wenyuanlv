...
+(float)set6Width:(float)width
{
    
    return width / 2 * [UIScreen mainScreen].bounds.size.width / 375;
    
}

+(float)set6Height:(float)height
{
    
    return height / 2 * [UIScreen mainScreen].bounds.size.height / 667;
