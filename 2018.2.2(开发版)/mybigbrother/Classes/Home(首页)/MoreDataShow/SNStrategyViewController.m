...
@interface SNStrategyViewController ()<UIScrollViewDelegate,QYQDifferentOrderStateHeaderDelegate,SDCycleScrollViewDelegate>
...
@implementation SNStrategyViewController
...
- (void)setupViews{
    ...
    listScroll.backgroundColor = [UIColor redColor];
