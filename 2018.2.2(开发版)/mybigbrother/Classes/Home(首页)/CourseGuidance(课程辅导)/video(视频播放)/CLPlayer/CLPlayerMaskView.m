...
- (UIButton *) backButton{
    if (_backButton == nil){
        ...
        [_backButton setImage:[self getPictureWithName:@""] forState:UIControlStateNormal];
        [_backButton setImage:[self getPictureWithName:@""] forState:UIControlStateHighlighted];
...
- (UIButton *) failButton
{
    if (_failButton == nil) {
        ...
        [_failButton setTitle:@"" forState:UIControlStateNormal];
