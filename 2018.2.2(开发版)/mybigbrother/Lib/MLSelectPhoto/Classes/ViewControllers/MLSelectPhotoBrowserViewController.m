...
@property (weak,nonatomic)      QYQMLSelectPhotoFlowLayout * flowLayout;
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        QYQMLSelectPhotoFlowLayout *flowLayout = [[QYQMLSelectPhotoFlowLayout alloc] init];
...
- (UIButton *)deleleBtn{
    if (!_deleleBtn) {
        ...
        [deleleBtn setImage:[[UIImage imageNamed:MLSelectPhotoSrcName(@"icon_image_no")] imageWithTintColor:[UIColor grayColor]] forState:UIControlStateNormal];
...
//    self.collectionView.contentOffset = CGPointMake(self.currentPage * self.collectionView.ml_width,
//                                                    self.collectionView.contentOffset.y);
//    [self.collectionView setContentOffset:CGPointMake(self.currentPage * self.collectionView.ml_width,
//                                                      self.collectionView.contentOffset.y)];
...
//                                        animated:YES];
    ...
    self.flowLayout.offsetpoint = CGPointMake(self.currentPage * self.collectionView.ml_width, 0.f);
    // 添加自定义View
