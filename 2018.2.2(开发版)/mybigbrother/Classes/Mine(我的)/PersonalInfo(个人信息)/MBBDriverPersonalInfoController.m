//
//  MBBDriverPersonalInfoController.m
//  mybigbrother
//
...
@interface MBBDriverPersonalInfoController ()<UITableViewDelegate,
...
@implementation MBBDriverPersonalInfoController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"个人信息";//司机
    ...
    _rightDatas = @[model.user.nickName?model.user.nickName:@"请填写",
                    ...
                    sex,
                    age,
                    model.user.driverModel?model.user.driverModel:@"请填写",
                    model.user.driverNumber?model.user.driverNumber:@"请填写",
                    model.user.driverCard?model.user.driverCard:@"请填写",
